...
1. `docs/PRINCIPLES.md` — operating principles (P1-P26).  Read
...
(one of P1-P26) explaining which principle motivated the
...
- `docs/PRINCIPLES.md` — the principles themselves (P1-P26).
