...
**Goal (1 sentence) (updated 2026-07-20)**: A **knowledge library** for the hermes-root family.  SUA holds agent behavior rules (25 P-n + 27 M-n), skill generation guidance ([SKILL_DESIGN.md](SKILL_DESIGN.md)), and cross-project coordination.  Active sibling projects: `../agent-reflection-skill/` (standalone skill since v1.0.0) and `../knowledge-graph-seed/` (frozen MVP, see README for status).  `../skill-incubator/` was archived on 2026-07-20; its content was consolidated back into SUA.
