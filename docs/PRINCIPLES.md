...
> L0: The 23 working principles (P1-P27 minus P6 + P15 + P16 + P24, merged into P5 + P3 per c47a+c78+c79+c80) of this project; P1-P21 in PRINCIPLES_DETAIL.md, P20+P21 + meta-rule pointers (P22, P23) here, P25 + P26 + P27 (also meta-rules) here.
...
| Test | P3, P5, P18, P19 | Unit → joint → integration, verify before commit (P5 merged with P6 + P15 + P16), failure → regression test, data-flow observability |
