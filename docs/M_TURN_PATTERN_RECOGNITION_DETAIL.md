...
2. **Apply pattern (L2)**: recognize 你 turn
   patterns.
...
**Example**: 你 turn "M-n 21 + top-down 默认"
...
**Example**: 你 turn "M-n 22 3W1H + 自顶向下"
...
**Example**: 你 turn 2026-07-15 (5 parts:
规划 角度 / 方法 / 任务管理 / 记录 / 学习
思路).  真问题 = "学习我发言思路这个
也需要看看有没有学习过".
...
**Example**: 你 turn "项目整洁 + skill 跟 SUA
...
- **Don't** ignore 你 turn 真问题
  (P17 老实说 requires 答).
- **Don't** confuse 你 turn 真意 with
...
2. c92 (M-n 12 terminology-clarity,
   per 你 turn "撞到一起" → "replan")
3. c98 (M-n 14 类比 vs 逻辑, per 你 turn
   "类比 是 抽象 + 归纳")
4. c106 (M-n 17 re-read, per 你 turn
   "经常 修改 文件 需要 确认")
5. c118 (M-n 21 ask-or-infer-mark-guess,
   per 你 turn "问 + 推理 + 标注猜测")
6. c122 (M-n 22 3W1H-think-first, per
   你 turn "自顶向下 之前 需要 3W1H")
7. 你 turn 2026-07-15 (this turn = 7th,
   Pattern C)
...
- **M-n 12**: refine 你 turn terms
- **M-n 14**: 类比 (find similar 你 turn) vs
  逻辑 (parse 1 turn)
- **M-n 17**: re-read before answering
- **M-n 21**: 答 真问题
- **M-n 22**: find 你 turn 真意
